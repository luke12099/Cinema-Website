...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/back_end/faq/css/faqback_add.css">
						...
						<table class="TKinner">
							...
							<tr>
								...
								<td><input style="text-align: center;" type="text"
									name="faq_title" size="45" value="${param.faq_title}"></td>
								<td>${errorMsgs.faq_title}</td>
							</tr>
							<tr>
								<td>內容:</td>
