<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%> <%--告知瀏覽器是UTF_8 ，以下程式文字敘述 UTF_8 --%>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back/member/listAllMember.jsp'>List</a> all Members.  <br><br></li>
