...
<div class="dialogue-wrapper">
    <div id="btn_open" class="dialogue-support-btn">
        ...
        <span class="dialogue-support-text">聯繫客服</span>
    </div>
    <div class="dialogue-main">
        ...
        <div id="dialogue_contain" class="dialogue-contain">
            <p class="dialogue-service-contain"><span class="dialogue-text dialogue-service-text">您好，請提問</span></p>
            <!-- <p class="dialogue-customer-contain"><span class="dialogue-text dialogue-customer-text">我有個問題</span></p> -->
        </div>
        <div class="dialogue-submit">
            <p id="dialogue_hint" class="dialogue-hint"><span class="dialogue-hint-icon">!</span><span class="dialogue-hint-text">發送內容不能為空</span></p>
            <textarea id="dialogue_input" class="dialogue-input-text" placeholder="請輸入您的問題，按Enter鍵提交（shift+Enter換行）"></textarea>
